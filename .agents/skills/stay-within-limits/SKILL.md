...
description: >
  Use before or within long/parallel implementation runs in this repo: CPCV
  parameter sweeps, per-asset notebook waves, bulk Polymarket reprocessing, or
  any run expected to exceed 30 minutes or 2 parallel subagents. Checks 5-hour
  and weekly usage between waves, pauses new work at 95% of either limit, and
  resumes only when the window is clear.
---

<!--
Vendored from https://github.com/BuilderIO/skills (skills/stay-within-limits)
at commit 72e70ce35653d98f56e8a779162b1a79b31b9187, adapted for
epsilon-quant-research: description retargeted to this repo's long-run shapes;
Chronicler-convention line added to Reporting. Upstream README.md kept
alongside for attribution.
-->
...
If a budget pause interrupts work mid-branch, the pause handoff must follow the
Chronicler convention from `brain/SKILL_MAP.md`: state what ran, what is still
pending, and where results landed.
