...
- Existing takeaway/status: Final Block A0 capture-status snapshot covering total event counts, gap logs, shard coverage, and per-market counts. It is a capture audit/status artifact, not an alpha verdict.
