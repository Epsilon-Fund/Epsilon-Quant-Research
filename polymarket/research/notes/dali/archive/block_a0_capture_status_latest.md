...
> **Canon status (2026-07-19 audit): HISTORICAL** — late checkpoint of the A0 capture; superseded by [[block_a0_capture_status_final]]. Full ledger: [[pm_prealvaro_canon_audit_findings]].
...
- Existing takeaway/status: Latest Block A0 capture-status snapshot covering event totals, gap logs, shard coverage, and per-market counts. Use it to understand data availability before reading A1-style analyses.
