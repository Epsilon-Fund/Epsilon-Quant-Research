...
> - **Build a latency model — it is cheap and easy** (a constant round-trip now; measure our *own* round-trip live by submitting a few unexecutable orders). It is part of the shared engine and pays off as we touch faster markets. I was too dismissive: constructing it is low-cost and worth it.
