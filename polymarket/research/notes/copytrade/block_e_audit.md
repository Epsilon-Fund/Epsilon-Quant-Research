...
| `polymarket/research/data/directionality_classification/metric_distributions.md` | Documents directionality metric distributions and thresholds. | `traders_directionality.parquet`. | Markdown distribution report. | gitignored data artifact; mtime 2026-05-16. |
