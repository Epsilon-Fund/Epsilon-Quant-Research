...
**dali — research lineage / redesign trail.** Direct local microstructure-continuation branches were falsified in specific retests, but dali itself is not closed; it is the broader Polymarket research line that kept redesigning into Block K, MM, OD, and future Justin-directed Polymarket work. Key falsification/redesign anchors: [[block_p3prime_oos_findings]], [[block_a0c_holdout_retest_findings]]. **Canon audit (2026-07-19): every dali note carries a verdict banner; the ledger is [[pm_prealvaro_canon_audit_findings]]** — 0 demotions, all closures robust; in-sample positives (73.7%, 64.1%, +7.74c) must only be cited with their kills.
